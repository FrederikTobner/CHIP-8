...
print("Building Emulator for x64 ...")
execute_command("cmake --build ../build/x64 --config Release --target CHIP-8")
...
print("Building Emulator for x86 ...")
execute_command("cmake --build ../build/x86 --config Release --target CHIP-8")
...
if is_windows then
  ...
  execute_command("zip -r ../build/chip8-x64.zip " .. zip_path)
end
...
if is_windows then
  ...
  execute_command("zip -r ../build/chip8-x86.zip " .. zip_path)
end
